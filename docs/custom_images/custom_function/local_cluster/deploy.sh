...
--set gateway.secrets.secretKey.create=true \
--set gateway.secrets.secretKey.value=CHANGE_ME \
--set gateway.secrets.servicePsql.create=true \
--set gateway.secrets.servicePsql.value.databaseName=serverlessdb \
--set gateway.secrets.servicePsql.value.databasePassword=serverlesspassword \
--set gateway.secrets.servicePsql.value.host=postgresql \
--set gateway.secrets.servicePsql.value.port=5432 \
--set gateway.secrets.servicePsql.value.userName=serverlessuser \
--set gateway.secrets.superuser.create=true \
--set gateway.secrets.superuser.value.name=admin \
--set gateway.secrets.superuser.value.password=passw0rd \
--set gateway.secrets.superuser.value.email=admin@examplemail.io \
