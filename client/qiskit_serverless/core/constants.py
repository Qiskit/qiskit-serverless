...
REQUESTS_TIMEOUT = int(
    os.getenv(REQUESTS_TIMEOUT_OVERRIDE, default=str(REQUESTS_TIMEOUT_DEFAULT))
)

REQUESTS_STREAMING_TIMEOUT = int(
    os.getenv(
        REQUESTS_STREAMING_TIMEOUT_OVERRIDE, default=str(REQUESTS_STREAMING_TIMEOUT_DEFAULT)
    )
)

MAX_ARTIFACT_FILE_SIZE_MB = int(
    os.getenv(
        MAX_ARTIFACT_FILE_SIZE_MB_OVERRIDE, default=str(MAX_ARTIFACT_FILE_SIZE_MB_DEFAULT)
    )
)
IBM_SERVERLESS_HOST_URL = os.getenv(
    IBM_SERVERLESS_HOST_URL_OVERRIDE, default=IBM_SERVERLESS_HOST_URL_DEFAULT
)
