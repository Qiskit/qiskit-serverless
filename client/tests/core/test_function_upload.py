...
# Tests for _upload_with_docker_image


@patch("qiskit_serverless.core.clients.serverless_client.requests.post")
def test_upload_with_docker_image_payload_contains_all_fields(mock_post):
...
@patch("qiskit_serverless.core.clients.serverless_client.requests.post")
def test_upload_with_docker_image_optional_fields_default_correctly(mock_post):
...
# Tests for _upload_with_artifact


@patch("qiskit_serverless.core.clients.serverless_client.requests.post")
def test_upload_with_artifact_payload_contains_all_fields(mock_post):
    """All fields from QiskitFunction are serialized correctly in the POST data."""
    mock_post.return_value = _make_mock_response(title="my-function", provider="my-provider")
...
@patch("qiskit_serverless.core.clients.serverless_client.requests.post")
def test_upload_with_artifact_optional_fields_default_correctly(mock_post):
    """Optional fields default to None / empty collections when not set."""
    mock_post.return_value = _make_mock_response()
...
def test_upload_with_artifact_raises_when_entrypoint_does_not_exist():
...
@patch("qiskit_serverless.core.clients.serverless_client.requests.post")
def test_upload_with_artifact_tar_is_cleaned_up_after_upload(mock_post):
