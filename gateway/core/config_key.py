...
class ConfigKey(Enum):
    ...
    KAFKA_OUTBOX_ENABLED = "scheduler.kafka_outbox.enabled"
    KAFKA_OUTBOX_BATCH_SIZE = "scheduler.kafka_outbox.batch_size"
    KAFKA_OUTBOX_BUDGET_MS = "scheduler.kafka_outbox.budget_ms"
    KAFKA_OUTBOX_BREAKER_FAILURES = "scheduler.kafka_outbox.breaker_failures"
    KAFKA_OUTBOX_BREAKER_PAUSE_SECONDS = "scheduler.kafka_outbox.breaker_pause_seconds"
