...
PLATFORM_PERMISSION_USER_FILES = "function.edit"  # list, download, upload and delete files in user space
# Provider admin permissions
PLATFORM_PERMISSION_PROVIDER_UPLOAD = "function.upload"  # create or update this function's code
PLATFORM_PERMISSION_PROVIDER_JOBS = "function-job.list"  # list jobs from all users of this function
PLATFORM_PERMISSION_PROVIDER_LOGS = "function-log.read"  # read provider-side logs of jobs from this function
PLATFORM_PERMISSION_PROVIDER_FILES = "function.manage"  # list, download, upload, delete files in provider space
