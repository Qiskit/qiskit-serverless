...
# Code Engine project definitions: JSON array delivered via deployment manifest.
# Each entry must contain: project_id, project_name, region, resource_group_id,
# subnet_pool_id, pds_name_state, pds_name_users, pds_name_providers,
# cos_instance_name, cos_key_name, cos_bucket_task_store_name,
# cos_bucket_user_data_name, cos_bucket_provider_data_name.
...
RAY_NODE_IMAGE = os.environ.get("RAY_NODE_IMAGE", "icr.io/quantum-public/qiskit-serverless/ray-node:0.32.0")
