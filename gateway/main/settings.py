...
RAY_NODE_IMAGE = os.environ.get("RAY_NODE_IMAGE", "icr.io/quantum-public/qiskit-serverless/ray-node:0.31.0")
...
# COS
RAY_COS_ENDPOINT = os.environ.get("COS_ENDPOINT", None)
RAY_COS_BUCKET = os.environ.get("COS_BUCKET", None)
RAY_COS_ACCESS_KEY = os.environ.get("COS_ACCESS_KEY", None)
RAY_COS_SECRET_KEY = os.environ.get("COS_SECRET_KEY", None)

FLEETS_USERS_COS_ENDPOINT = os.environ.get("FLEETS_USERS_COS_ENDPOINT", None)
FLEETS_USERS_COS_BUCKET = os.environ.get("FLEETS_USERS_COS_BUCKET", None)
FLEETS_USERS_COS_ACCESS_KEY = os.environ.get("FLEETS_USERS_COS_ACCESS_KEY", None)
FLEETS_USERS_COS_SECRET_KEY = os.environ.get("FLEETS_USERS_COS_SECRET_KEY", None)

FLEETS_PARTNERS_COS_ENDPOINT = os.environ.get("FLEETS_PARTNERS_COS_ENDPOINT", None)
FLEETS_PARTNERS_COS_BUCKET = os.environ.get("FLEETS_PARTNERS_COS_BUCKET", None)
FLEETS_PARTNERS_COS_ACCESS_KEY = os.environ.get("FLEETS_PARTNERS_COS_ACCESS_KEY", None)
FLEETS_PARTNERS_COS_SECRET_KEY = os.environ.get("FLEETS_PARTNERS_COS_SECRET_KEY", None)
