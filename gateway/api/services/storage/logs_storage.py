...
from api.services.storage.cos_client import cos_client
...
class LogsStorage:
    ...
    Methods with _cos suffix use S3
    """
    ...
    def get_public_logs(self) -> Optional[str]:
        ...
        return cos_client.get_object(f"{self._public_key}/{self._job_id}{self.FILE_EXTENSION}")

    def save_public_logs(self, logs: str) -> None:
        """Save public logs for the job to filesystem."""
    ...
    def get_private_logs(self) -> Optional[str]:
        ...
        return cos_client.get_object(f"{self._private_key}/{self._job_id}{self.FILE_EXTENSION}")

    def save_private_logs(self, logs: str) -> None:
        """Save private logs for the job to filesystem."""
